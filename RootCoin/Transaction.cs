...
namespace RootCoin
{
    public class Transaction
    {
        ...
        public Transaction(PublicKey fromAddress, PublicKey toAddresss, decimal amount)
        {
        ...
        public void SignTransaction(PrivateKey signingKey)
        {
            ...
            this.Signature = Ecdsa.sign(toHash, signingKey);
        ...
        public bool IsValid()
        {
            ...
            {
                throw new Exception("No signature in this transactio");
            }
